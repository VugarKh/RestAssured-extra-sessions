...
public class APITask1 extends TypiCodeTestBase {
    ...
    public void task3(){
        ...
        Response response = given().accept(ContentType.JSON).pathParam("id", 12345)
                .when().get("post/{id}");
    ...
    public void task4(){
        ...
        //- When user sends request to  https://jsonplaceholder.typicode.com/posts/%7Bid%7D/comments
        //- Then status code is 200
        //
        //- And header Content - Type is Json
